...
It is possible to integrate a file contaning pure \LaTeX code into this report.
To do this, create a \TeX file and use command \texttt{\textbackslash{}input\{content/filename.tex\}} in one of your (R)md-documents.
...
Likewise, bibliographic references \cite{paper1} are handled with ease.
!`\TeX\ can g\`{e}n\'{e}rate alm\"{o}st all the accents and
spe\c{c}ial symbols used in Western \cite{paper2} l\aa nguages! Likewise,
